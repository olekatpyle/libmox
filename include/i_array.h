...
/**
 * Function to push element to next free index in i_array, in general at the end.
 *
 ...
 * @return the value found at specified position or -1 if out of bounds
 * */
 ...
 * @return pointer to the copy of ia
 * */
